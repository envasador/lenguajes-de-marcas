...
|---|---|---|---|---|---|
| GML | Estructurar documentos para impresión | N/A | Interés histórico | Básico | `:title.General Markup` |
...
| Markdown | Escribir texto con formato ligero | N/A | Documentación, README, estos mismos apuntes | Ligero | `# Title` |
